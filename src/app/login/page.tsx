      ...
      <CardContent className="space-y-4 pt-0">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Button
            ...
            className="h-10 text-xs border-border/80 hover:bg-accent/40 font-bold gap-1.5 cursor-pointer"
          >
            <svg className="h-4 w-4 mr-1 text-foreground" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export default function LoginPage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-140px)] py-8 relative">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-72 h-72 bg-primary/20 rounded-full blur-3xl -z-10" />
      <div className="absolute bottom-1/4 left-1/3 w-60 h-60 bg-indigo-500/10 rounded-full blur-3xl -z-10" />
